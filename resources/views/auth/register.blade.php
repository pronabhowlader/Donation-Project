                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="method" id="method" class="form-control{{ $errors->has('method') ? ' is-invalid' : '' }}" required autofocus>
                        ...
                        {{-- Amount --}}
                        <div class="form-group row">
                            <label for="amount" class="col-md-4 col-form-label text-md-right">{{ __('Amount (TK)') }}</label>
